...
<span class="bb_BATUU" id="barnensbiblCurrentUserid"><%= UserController.Instance.GetCurrentUserInfo().UserID%></span>
...
<dnn:DnnJsInclude runat="server" FilePath="public/js/aj_batuu.1.2.0.js" PathNameAlias="SkinPath" />
<dnn:DnnJsInclude runat="server" FilePath="public/js/setposition.js" PathNameAlias="SkinPath" />
